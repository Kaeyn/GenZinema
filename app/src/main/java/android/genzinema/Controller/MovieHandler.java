...
public class MovieHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (1,'Overlord','5','1','1tazr67-wERTdQ9tCdnJBiK3-P_ZqWJU0/view?usp=drive_link','Albedo, Titan, Victim, Coctyus','Trí Tony','2019','Cốt truyện anime sẽ đưa khán giả đến năm 2138 trong tương lai, khi khoa học công nghệ phát triển vượt bậc và ngành game thực tế ảo đang nở rộ hơn bao giờ hết. Yggdrasil, một game online vô cùng phổ biến thời gian đó bỗng dưng bị đóng cửa đột ngột','overlord','1tazr67-wERTdQ9tCdnJBiK3-P_ZqWJU0/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (2,'Yinan','2','1','19nUvhiA3YeoHsT-mQSPVtxaMh_3CRV8F/view?usp=drive_link','Min Assung, Dook Hen, Dan Hen','JonhnWajiz','2008','Phim kinh dị không dành cho trẻ em dưới 16+.','yinan','19nUvhiA3YeoHsT-mQSPVtxaMh_3CRV8F/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (3,'Thất nghiệp chuyển sinh','5','2','16pmiD1vUO1mpNWU85vTgdsZ_fYiu4Ks4/view?usp=drive_link','Albedo, Titan, Victim, Coctyus','JohnATDR','2021','Một tên NEET 34 tuổi đã bị đuổi khỏi nhà sau cái chết của gia đình hắn. Hắn ngăn chặn một nhóm người thiếu niên ra khỏi một chiếc xe tải đang chạy và đã đẩy một người trong nhóm người đó ra thành công trước khi hắn chết.','ttcs','16pmiD1vUO1mpNWU85vTgdsZ_fYiu4Ks4/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (4,'Doraemon','5','1','1uAJ_UfmUVGDLyN9q3r6ElP5_2ESiEd_U/view?usp=drive_link','Doraemon, Nobita, Chaien, Shizuka, Suneo','ODA','2000','Các câu chuyện trong Doraemon thường có một công thức chung, đó là xoay quanh những rắc rối hay xảy ra với cậu bé Nobita học lớp bốn, nhân vật chính thứ nhì của bộ truyện.','doraemon','1uAJ_UfmUVGDLyN9q3r6ElP5_2ESiEd_U/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (5,'Siêu nhân','1','2','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link','Min Assung, Dook Hen, Dan Hen','JohnATDR','2010','Phim dành cho mọi lứa tuổi, lành mạnh cho trẻ nhỏ','sieunhan','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (6,'Hậu duệ mặt trời','3','2','1-rsqefaW117LwMVB3mG5mmIMVsS3wZTe/view?usp=drive_link/view?usp=drive_link','Soong Joong Ki, Song Hye Kyo, Jin Goo, Kim Ji Won','JohnATDR','2018','Hậu duệ mặt trời (Hangul: 태양의 후예; RR: Taeyangui Huye) là một bộ phim truyền hình Hàn Quốc năm 2016 có sự tham gia của Song Joong-ki, Song Hye-kyo, Jin Goo và Kim Ji-won.Phim được phát sóng trên kênh KBS2 từ ngày 24 tháng 2 đến ngày 14 tháng 4 năm 2016 cho 16 tập','haudemattroi','1-rsqefaW117LwMVB3mG5mmIMVsS3wZTe/view?usp=drive_link/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (7,'FapTV','4','1','19nUvhiA3YeoHsT-mQSPVtxaMh_3CRV8F/view?usp=drive_link','Vinh Râu, Ribi Sachi, Thái Vũ, Phương','Đức Trần','2005','Phim hài hước dành cho gia đình.','faptv','19nUvhiA3YeoHsT-mQSPVtxaMh_3CRV8F/view?usp=drive_link')";
        db.execSQL(sql);
        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (8,'Bố già','3','1','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link','Trấn Thành, Lê Giang, Tuấn Trần, Lan Phương, Hương Giang','Trấn Thành','2021','Bố già (tiếng Anh: The Godfather) là một bộ phim hình sự sản xuất năm 1972 dựa theo tiểu thuyết cùng tên của nhà văn Mario Puzo và do Francis Ford Coppola đạo diễn.','bogia','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
        db.execSQL(sql);
        ...
        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (1,'JohnWaj','1','1','1S9Fj7wPhvFktzE5Pk4XWJ6ClLFRaadBW','Jon','Tony','2121','Phim rat hay.','overlord','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (2,'Wajigi','4','1','1ENAzcgYVihG8NHmeNDOrxh3mjzJLjD0r','Min','JonhnWajiz','2921','Phim danh cho anh JohnWaji.','sieunhan','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (3,'Joji','2','2','1EUXzjIRJFniKTiHg9sW_T14eByhyCvcN','Jin','JohnATDR','221','Phim hay heo hut.','ttcs','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (4,'Jojaemon','1','1','1EUXzjIRJFniKTiHg9sW_T14eByhyCvcN','Jin','JohnATDR','221','Phim hay heo hut.','doraemon','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (5,'Joji','1','2','1EUXzjIRJFniKTiHg9sW_T14eByhyCvcN','Jin','JohnATDR','221','Phim hay heo hut.','sieunhan','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
//        sql = "INSERT OR IGNORE INTO " + TABLE_NAME +" VALUES (6,'Joji','1','2','1EUXzjIRJFniKTiHg9sW_T14eByhyCvcN','Jin','JohnATDR','221','Phim hay heo hut.','sieunhan','1UQdmP460mYAZKXw-UAamjCwZJhTPWWU9/view?usp=drive_link')";
//        db.execSQL(sql);
